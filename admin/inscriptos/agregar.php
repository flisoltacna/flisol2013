    					...
    					<form action="agregar.php" id="publicaciones" method="post" accept-charset="utf-8">
    						<div class="row-fluid">
    							<div class="span5">
	    							...
	    							<input name="nombres" class="span12" maxlength="120" type="text" id="InscripcionNombres" required="required" />
    							</div>
    							<div class="span6">
    								<label for="InscripcionApellidos">Apellidos</label>
    								<input name="apellidos" class="span12" maxlength="120" type="text" id="InscripcionApellidos" required="required" />
    							</div>
    						</div>
    						<div class="row-fluid">
    							<div class="span3">
    								<label for="InscripcionDni">D.N.I.</label>
    								<input name="dni" class="span12" maxlength="8" type="text" id="InscripcionDni"/>
    							</div>
    							<div class="span5">
    								<label for="InscripcionEmail">Email</label>
									<input name="email" class="span12" maxlength="200" type="text" id="InscripcionEmail" required="required" />
								</div>
								<div class="span3">
									<label for="InscripcionTelefono">Teléfono</label>    							
    								<input name="telefono" class="span12" maxlength="15" type="text" id="InscripcionTelefono"/>  
								</div>
    						</div>
    						<div class="control-group">
    							<label for="InscripcionInstitucion">Institución</label>
    							<div class="controls">
    								<input name="institucion" class="span8" maxlength="225" type="text" id="InscripcionInstitucion" />
    							</div>
    						</div>
    						<div class="control-group">
